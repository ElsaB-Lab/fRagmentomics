#' @title A user-friendly R package, that enables the characterization
...
#'
#' @description fRagmentomics supports multiple mutation input formats (e.g.,
