#' Trim Soft-Clipped Bases from a Read
#' This function parses a CIGAR string to identify and remove
#' soft-clipped bases from the 5' and 3' ends of a sequence and its
#' corresponding quality string. It also updates the CIGAR string.
#'
