test_that("process_get_fragment_bases_softclip", {
  ...
  expect_equal(res1$Nb_SC_5p, 45)
  expect_equal(res1$Nb_SC_3p, 30)
  ...
  expect_equal(res2$Nb_SC_5p, 0)
  expect_equal(res2$Nb_SC_3p, 30)
