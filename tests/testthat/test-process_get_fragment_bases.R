test_that("process_get_fragment_bases", {
  ...
  expect_equal(res2$fragment_bases_5p, "Number of bases in 5p and 3p bigger than the fragment length")
  expect_equal(res2$fragment_bases_3p, "Number of bases in 5p and 3p bigger than the fragment length")
  expect_equal(res2$fragment_Qbases_5p, "Number of bases in 5p and 3p bigger than the fragment length")
  expect_equal(res2$fragment_Qbases_3p, "Number of bases in 5p and 3p bigger than the fragment length")
