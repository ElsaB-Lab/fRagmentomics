test_that("get_fragment_bases_softclip", {
  # Case 1: report_softclip == TRUE, both cigar strings have soft clips.
  res1 <- get_fragment_bases_softclip("45S100M", "100M30S")
  ...
  res2 <- get_fragment_bases_softclip("100M", "20S100M30S")
  ...
  res3 <- get_fragment_bases_softclip("45S100M", "100M")
  ...
  res4 <- get_fragment_bases_softclip("100M", "100M")
