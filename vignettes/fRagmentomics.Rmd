...
author:
  - name: "Killian Maudet"
    affiliation: "UMR 981, Gustave Roussy, Villejuif, France"
...
if (!has_bcftools) {
  message("bcftools not found on PATH; normalization examples will run without it.")
}
```
...
if (!has_bcftools) {
  message("bcftools not detected; running advanced workflow without external normalization.")
}
