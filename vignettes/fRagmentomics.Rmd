...
During the processing, fRagmentomics will standardize your indel representation and position because of the different possibiles of representation.
...
To only considers reads within a 1600 bp window around the variant's position thanks ot the parameters `neg_offset_mate_search` and `pos_offset_mate_search`.
