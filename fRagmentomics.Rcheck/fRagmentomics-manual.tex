...
\item[Author]\AsIs{Killian Maudet [aut, cre],
...
%
\begin{Author}
\strong{Maintainer}: Killian Maudet \email{killian.maudet@gustaveroussy.fr}
...
\item{} \strong{Output Generation}: Results from all variants are aggregated into a single data frame. If an 'output\_file'
...
\end{Value}
\HeaderA{fRagmentomics}{fRagmentomics: Per-Fragment Analysis of cfDNA characteristics}{fRagmentomics}
%
\begin{Description}
A user-friendly R package that enables the characterization
of each cfDNA fragment overlapping one or multiple mutations of interest,
...
%
\begin{SeeAlso}
The primary function for analysis: \code{\LinkA{analyze\_fragments}{analyze.Rul.fragments}}
\end{SeeAlso}
%
\begin{Examples}
\begin{ExampleCode}
